...
"""
def getData(file):
    data = pd.read_csv('/home/irteam/wendyunji-dcloud-dir/wendyunji/Dataset/MLAC-dataset/originalwithdlabel_'+file+'.csv')
    return data
...
def returnData(file, x_data, y_data):
    ...
    encoded.to_csv('/home/irteam/wendyunji-dcloud-dir/wendyunji/Dataset/MLAC-dataset/encodedwithdlabel_'+file+'.csv', index=False)
    return encoded