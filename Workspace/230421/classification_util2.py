...
def MultiClassification(file, models, X_train, X_test, y_train, y_test):
    ...
    for name, model in models:
        ...
        cnt += 1
        matrix = open('/home/irteam/wendyunji-dcloud-dir/wendyunji/2023-1/MLAC/Workspace/230421/matrix/'+file+'_'+name+'.txt','w')
        matrix.write(str(confusion))            
    accuracy = accuracy.round(3)
    accuracy.to_csv('/home/irteam/wendyunji-dcloud-dir/wendyunji/2023-1/MLAC/Workspace/230421/'+file+'.csv',index=False)
